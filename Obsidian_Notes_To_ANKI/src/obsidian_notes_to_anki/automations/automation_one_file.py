    ...
    try:
        if full_path.exists() and full_path.is_file():
            ...
            with open(full_path, "r", encoding='utf-8') as file_content:
                ...
                matching_lines = [index for index, line in enumerate(content) if TEXT_TO_SEARCH in line]
                ...
                if len(matching_lines) > 0:
                    ...
                    with open(full_path, "w", encoding='utf-8') as file_content:
                        ...
                        line2 = content[matching_lines[0] + 1] if matching_lines[0] != len(content) - 1 else ""
                    ...
                    print(f"This file: '{full_path.name}' is not a note (ANKI <-> Obsidian) or has been modified previously in this path: {full_path}")
                    print("Exiting the script...")
                    return
