...
### [My-second-prorgam](My-second-prorgam/)
Una versión del clásico juego "Tres en Raya" (Tic-Tac-Toe) desarrollada con Tkinter y CustomTkinter. Incluye una interfaz gráfica estilizada para jugar en un tablero interactivo.
*🪟 Optimizado para Windows (usa emojis específicos del sistema).*

### [My-first-program](My-first-program/)
Una calculadora gráfica desarrollada con la librería Tkinter. Presenta una interfaz clásica que permite realizar operaciones matemáticas básicas mediante botones de forma intuitiva.
*💻 Multiplataforma: Compatible con Windows, macOS y Linux.*

---
*Este repositorio se mantiene principalmente con fines de archivo y consulta personal.*
